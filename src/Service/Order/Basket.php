...
class Basket
{
    ...
    /**
     * Оформление заказа
     * @param CheckoutBuilderInterface
     * @return void
     * @throws BillingException
     * @throws CommunicationException
     */
    public function checkout(CheckoutBuilderInterface $builder): void
    {
        $checkout = new BasketCheckoutFacade(new CheckoutConstructor(),new CheckoutBuilder());
        $this->checkoutProcess($checkout->build($this->session));
    }
    ...
    public function checkoutProcess(
      Checkout $checkout
        ...
        $discount = $checkout->nullObject;
        $billing = $checkout->card;
        $security = $checkout->security;
        $communication = $checkout->email;
