...
use Framework\Command\ConfigCommandHandler;
use Framework\Command\RoutesCommandHandler;
...
class Kernel
{
    ...
    {
        $registerConfigsCommand = new RegisterConfigsCommand($this->containerBuilder);
        $registerRoutesCommand = new RegisterRoutesCommand($this->containerBuilder);

        (new ConfigCommandHandler($registerConfigsCommand))->execute();
        (new RoutesCommandHandler($registerRoutesCommand))->execute();
